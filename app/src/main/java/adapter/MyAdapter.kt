...
class MyAdapter(private val breedValues: List<String>, private val confidenceValues: List<String>, var onLearnListener : OnLearnListener): RecyclerView.Adapter<MyAdapter.ViewHolder>() {
